...
class MOT16ObjDetect(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, root: str, transforms=None, vis_threshold=0.25):
        """
        Initialize the MOT16 Object Detection dataset.

        :param str root: Path to the directory of the dataset.
        :param Compose transforms: A `Compose` object containing the transformations to be applied to the images and annotations.
    ...
    def _get_annotation(self, idx):
        """
        Get the annotation for image at index `idx`. Includes bounding boxes with visibility above threshold.

        :param int idx: Index of the image for which the annotation should be returned.
        """
    ...
    def __getitem__(self, idx):
        """
        Get the image and annotation at index `idx`.

        :param int idx: Index of the image and annotation to be returned.
        """
